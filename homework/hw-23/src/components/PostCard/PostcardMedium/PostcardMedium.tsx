...
import mediumStyle from "./Postcard.medium.module.css";
...
export default function PostCardMedium({ post }: PostProps) {
  ...
  return (
    <div className={mediumStyle.postCard}>
      <div className={mediumStyle.postCardTop}>
        ...
        <div className={defaultStyle.postContentText}>
          ...
          <h1 className={mediumStyle.postTitle}>{title}</h1>
        </div>
      </div>
